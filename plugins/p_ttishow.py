    ...
    if temp.ME in r_j_check:
        ...
        buttons = [
            [
                InlineKeyboardButton(
                    "ℹ️ 𝖧𝖤𝖫𝖯", url=f"https://t.me/{temp.U_NAME}?start=help"
                ),
        ...
        for u in message.new_chat_members:
            ...
            temp.MELCOW["welcome"] = await message.reply(
                f"<b>𝖧𝖾𝗒 , {u.mention}, 𝖶𝖾𝗅𝖼𝗈𝗆𝖾 𝖳𝗈 {message.chat.title}\n𝖳𝗁𝖺𝗇𝗄 𝖸𝗈𝗎 𝖥𝗈𝗋 𝖩𝗈𝗂𝗇𝗂𝗇𝗀 😍 </b>"
            )
...
async def pin(bot, message):
    if message.from_user.id == ADMIN:
        if message.reply_to_message:
            ...
            await p.pin()
            await message.reply_text(
                "<b>✅ Message Successfully Send to the Group And pinned</b>"
            )
